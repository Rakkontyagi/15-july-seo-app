...
export async function GET(
  ...
  try {
    ...
    // Get content
    const content = await wpService.getContent(resolvedParams.contentId);
...
export async function PATCH(
  ...
  try {
    ...
    logger.logApiCall({
      method: 'PATCH',
      path: `/api/cms/wordpress/${resolvedParams.contentId}`,
...
export async function DELETE(
  ...
  try {
    ...
    // Delete content
    const success = await wpService.delete(resolvedParams.contentId);
