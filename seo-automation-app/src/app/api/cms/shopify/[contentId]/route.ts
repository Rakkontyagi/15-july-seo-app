...
export async function GET(
  ...
  try {
    ...
    // Get product
    const content = await shopifyService.getContent(params.contentId);
...
export async function PATCH(
  ...
  try {
    ...
    logger.logApiCall({
      method: 'PATCH',
      path: `/api/cms/shopify/${params.contentId}`,
...
export async function DELETE(
  ...
  try {
    ...
    // Delete product
    const success = await shopifyService.delete(params.contentId);
