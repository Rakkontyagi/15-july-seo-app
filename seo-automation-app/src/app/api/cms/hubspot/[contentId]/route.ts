...
export async function GET(
  ...
  try {
    ...
    // Get blog post
    const content = await hubspotService.getContent(params.contentId);
...
export async function PATCH(
  ...
  try {
    ...
    logger.logApiCall({
      method: 'PATCH',
      path: `/api/cms/hubspot/${params.contentId}`,
...
export async function DELETE(
  ...
  try {
    ...
    // Delete blog post
    const success = await hubspotService.delete(params.contentId);
