...
const logger = createServiceLogger('intelligence-analyze-api');
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    logger.error('Error in competitive intelligence analysis:', { error: error instanceof Error ? error.message : error });
